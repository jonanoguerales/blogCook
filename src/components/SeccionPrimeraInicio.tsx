            ...
            <div className="mx-auto max-w-screen-3xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:h-max lg:grid-cols-2">
                    ...
                    <div className="relative flex items-center bg-sky-100 lg:rounded-r-lg max-lg:rounded-b-lg">
                        <span
                            className="hidden lg:absolute lg:inset-y-0 lg:-start-16 lg:block lg:w-16 bg-sky-100"
                        ></span>
                        ...
                        <div className="p-8 sm:p-16 lg:p-24">
                            ...
                            <p className="mt-4 text-gray-600">
                                La panceta es un corte de carne de cerdo muy consumido que gustará a todos. Intercalado con carne, piel de cerdo y grasa, resulta perfecto a la parrilla, frito o asado y, en esta ocasión, aprenderemos a preparar una deliciosa panceta en la airfryer muy bien condimentada, preparada con azúcar moreno, mostaza y otros condimentos. Cortado en cubos o
                                rectángulos, puede presentarse incluso como aperitivo.
                            </p>
